<?php
  ...
  $btn_sair = '<li class="nav-item"><a class="nav-link text-mlaa" href="?sair">Sair</a></li>';
  $btn_buscar = '<li class="nav-item"><a  id="buscar" class="nav-link text-mlaa" href="?pg=buscar">Buscar</a></li>';
  $btn_minhas_solicitacoes = '<li class="nav-item"><a id="minhasSolicitacoes" class="nav-link text-mlaa" href="?pg=minhas-solicitacoes">Minhas Solicitações</a></li>';
  $btn_imprimir_etiqueta = '<li class="nav-item"><a  id="imprimir" class="nav-link text-mlaa" href="?pg=imprimir-etiqueta">Imprimir Etiqueta</a></li>';
  $btn_limpar = '<li class="nav-item"><a  id="limpar" class="nav-link text-mlaa" href="?pg=limpa-banco">Limpar</a></li>';
  $btn_importar = '<li class="nav-item"><a  id="importar" class="nav-link text-mlaa" href="?pg=importar">Importar</a></li>';
  $btn_cad_cliente = '<a class="dropdown-item text-mlaa" href="?pg=cadastrar-cliente">Cliente</a>';
  $btn_cad_documento = '<a class="dropdown-item text-mlaa" href="?pg=cadastrar-documento">Documento</a>';
  $btn_cad_usuario = '<a class="dropdown-item text-mlaa" href="?pg=cadastrar-usuario">Usuário</a>';
  $btn_cad_prateleira = '<a class="dropdown-item text-mlaa" href="?pg=cadastrar-prateleira">Prateleira</a>';
  $btn_edit_cliente = '<a class="dropdown-item text-mlaa" href="?pg=editar-cliente">Cliente</a>';
  $btn_edit_documento = '<a class="dropdown-item text-mlaa" href="?pg=editar-documento">Documento</a>';
  $btn_edit_usuario = '<a class="dropdown-item text-mlaa" href="?pg=editar-usuario">Usuário</a>';
  $btn_edit_localizacao = '<a class="dropdown-item text-mlaa" href="?pg=editar-localizacao">Localização</a>';
  $btn_gerar_codigo = '<a id="codigo" class="dropdown-item text-mlaa" href="?pg=gerar-codigo">Código</a>';
  $btn_gerar_caixa = '<a id="caixa" class="dropdown-item text-mlaa" href="?pg=gerar-localizacao&tipo=caixa">Caixa</a>';
  $btn_gerar_pasta = '<a id="caixa" class="dropdown-item text-mlaa" href="?pg=gerar-localizacao&tipo=pasta">Pasta</a>';
  $btn_gerar_etiqueta = '<a id="etiqueta" class="dropdown-item text-mlaa" href="?pg=gerar-etiqueta">Etiqueta</a>';

  if($tipo_usuario == '1'){
    $btn_cadastrar = '
      <li class="nav-item dropdown">
        <a id="cadastrar" class="nav-link dropdown-toggle text-mlaa" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Cadastrar</a>
    ...
    $btn_editar = '
      <li class="nav-item dropdown">
        <a id="editar" class="nav-link dropdown-toggle text-mlaa" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Editar</a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">'.
          $btn_edit_cliente.
          $btn_edit_documento.
          $btn_edit_usuario.
    ...
    $btn_gerar = '
      <li class="nav-item dropdown">
        <a id="gerar" class="nav-link dropdown-toggle text-mlaa" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Gerar</a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">'.
          $btn_gerar_codigo.
          $btn_gerar_caixa.
          $btn_gerar_pasta.
...
<html lang="pt-BR">
  <head>
    ...
    <style type="text/css">
      *{
      ...
      .text-mlaa {
        color: #A77654 !important;
      }
      a.text-mlaa:focus, a.text-mlaa:hover {
  ...
  <body>
    <nav style="background: #00263D;" class="text-mlaa navbar navbar-toggleable-md sticky-top navbar-inverse hidden-print">
      <?php echo $menu_mobile; ?>
      <a class="navbar-brand" href="?pg=home">
        <img src="img/logo.png" width="30" alt="Logo do Escritório"/>
        <span class="ml-2 text-mlaa"><?php echo (isset($nome_usuario) ? $nome_usuario : 'Sistema de Arquivamento'); ?></span>
      </a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" id="btnSolicitaRedefinirSenha" onclick="enviaSolicitacaoRedefinicaoSenha();" class="btn btn-success">Enviar</button>
        </div>
      </div>
    </div>
  </div>
